...
public class RequestRepositoryTests {
	...
	public void AsaveTest() {
		...
		Request request = new Request(null, "Novo Laptop DP", "Pretendo obter um laptop HP", new Date(), RequestState.OPEN, owner, null);
	...
	public void updateTest() {
		...
		Request request = new Request(1L, "Novo Laptop DP", "Pretendo obter um laptop HP, de RAM 16 GB", null, RequestState.OPEN, owner, null);
