...
@SpringBootTest
public class RequestStageRepositiryTeste {
	@Autowired private RequestStageRepositiry requestStageRepositiry;
	...
	public void getByIdTest() {
		Optional<RequestStage> result = requestStageRepositiry.findById(1L);
